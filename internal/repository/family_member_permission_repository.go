...
type FamilyMemberPermissionRepository interface {
	CreateFamilyMemberPermission(family *family.FamilyMemberPermission) error
	GetFamilyMemberPermissionByID(id uint) (*family.FamilyMemberPermission, error)
	GetFamilyMemberPermissionByUserID(userID uint) (*family.FamilyMemberPermission, error)
	UpdateFamilyMemberPermission(family *family.FamilyMemberPermission) error
	DeleteFamilyMemberPermission(family *family.FamilyMemberPermission) error
	GetAllFamilyMemberPermissions() ([]family.FamilyMemberPermission, error)
	GetFamilyMemberPermissionsByFamilyID(familyID uint) ([]family.FamilyMemberPermission, error)
	GetFamilyMemberPermissionsByMemberID(memberID uint) ([]family.FamilyMemberPermission, error)
	GetFamilyMemberPermissionsByFamilyIDAndMemberID(familyID uint, memberID uint) (*family.FamilyMemberPermission, error)
...
func (r *familyMemberPermissionRepository) CreateFamilyMemberPermission(family *family.FamilyMemberPermission) error {
	return r.db.Table(utils.TableFamilyMemberPermissionName).Create(family).Error
}

func (r *familyMemberPermissionRepository) GetFamilyMemberPermissionByID(id uint) (*family.FamilyMemberPermission, error) {
	var familyMemberPermission family.FamilyMemberPermission
...
func (r *familyMemberPermissionRepository) GetFamilyMemberPermissionByUserID(userID uint) (*family.FamilyMemberPermission, error) {
	var familyMemberPermission family.FamilyMemberPermission
...
func (r *familyMemberPermissionRepository) UpdateFamilyMemberPermission(family *family.FamilyMemberPermission) error {
	return r.db.Table(utils.TableFamilyMemberPermissionName).Save(family).Error
}

func (r *familyMemberPermissionRepository) DeleteFamilyMemberPermission(family *family.FamilyMemberPermission) error {
	return r.db.Table(utils.TableFamilyMemberPermissionName).Delete(family).Error
}

func (r *familyMemberPermissionRepository) GetAllFamilyMemberPermissions() ([]family.FamilyMemberPermission, error) {
	var familyMemberPermissions []family.FamilyMemberPermission
...
func (r *familyMemberPermissionRepository) GetFamilyMemberPermissionsByFamilyID(familyID uint) ([]family.FamilyMemberPermission, error) {
	var permissions []family.FamilyMemberPermission
...
func (r *familyMemberPermissionRepository) GetFamilyMemberPermissionsByMemberID(memberID uint) ([]family.FamilyMemberPermission, error) {
	var permissions []family.FamilyMemberPermission
...
func (r *familyMemberPermissionRepository) GetFamilyMemberPermissionsByFamilyIDAndMemberID(familyID uint, memberID uint) (*family.FamilyMemberPermission, error) {
	var permission family.FamilyMemberPermission
